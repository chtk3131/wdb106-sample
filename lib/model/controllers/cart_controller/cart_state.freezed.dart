...
class _$_CartState extends _CartState {
  ...
  bool _didsortedItem = false;
  List<CartItem> _sortedItem;

  @override
  List<CartItem> get sortedItem {
    if (_didsortedItem == false) {
      _didsortedItem = true;
      _sortedItem = itemMap.values.toList()
  ...
  @override
  String toString() {
    return 'CartState(itemMap: $itemMap, sortedItem: $sortedItem, summary: $summary)';
  }
